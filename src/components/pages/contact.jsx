...
<div class="contact-container">
    ...
    <div class="contact-box">
        <h2>Contact Us!</h2>
        <form class="contact-form" id="contact-form" ref={form} onSubmit={sendEmail}>
        <input type="text" id="name" name="from_name" placeholder="Your Name*" required/> <br/>
        <input type="email" id="email" name="from_email" placeholder="Email Address*" required/><br/>   
